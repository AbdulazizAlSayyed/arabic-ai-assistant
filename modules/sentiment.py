...
Bilingual support (Arabic + English) with ML and rule-based fallback
CAMeL BERT model for enhanced Arabic sentiment
"""
...
ARABIC_POSITIVE = {
    ...
    "أفضل", "مسرور", "مبسوط", "حسن", "قوي", "رائعة", "ممتازة"
}
...
ARABIC_NEGATIVE = {
    ...
    "محبط", "مستاء", "زعلان", "بشع", "قبيح", "كره", "أكره", "مزعجة", "فاشلة"
}
...
ENGLISH_NEGATIVE = {
    ...
    "mad", "annoyed", "frustrating", "disgusting", "terrible", "awful"
}
...
def analyze_sentiment_with_camel(text: str) -> dict:
    try:
        ...
        return {
            ...
            "method": "CAMeL-BERT (Arabic Transformer)",
            "confidence": result["score"]
        }
    except Exception as e:
        print(f"CAMeL sentiment error: {e}")
        return None
...
def analyze_sentiment(text: str) -> dict:
    ...
    lang = detect_language(text)
    if lang == "ar":
        camel_result = analyze_sentiment_with_camel(text)
