...
def _get_openai_client():
    ...
    if not api_key:
        raise ValueError(
            ...
            "Run: setx OPENAI_API_KEY 'your-key-here' and restart terminal."
        )
...
def build_index():
    """Build search index from knowledge base documents"""
...
def fallback_answer(retrieved_chunks: List[Dict]) -> str:
    ...
    return (
        "بناءً على المعلومات المسترجعة من قاعدة المعرفة:\n\n"
...
def answer_question(question: str, top_k: int = 3) -> dict:
    ...
    Returns:
        dict: {"question": str, "answer": str, "retrieved_chunks": List[Dict]}
    """
